        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="bg-slate-50 border border-slate-150 p-8 rounded-2xl relative shadow-sm">
            ...
            <div className="mt-6 flex items-center justify-center space-x-3">
              <div className="h-9 w-9 rounded-full bg-indigo-100 border border-indigo-200 text-indigo-700 flex items-center justify-center text-xs font-bold font-mono shadow-sm">
                JS
              </div>
